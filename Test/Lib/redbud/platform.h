// Some preprocessing macros related to the platform

#ifndef REDBUD_PLATFORM_H_
#define REDBUD_PLATFORM_H_
...
// compiler
    ...
    #define REDBUD_MSCV _MSC_VER_
#else
    #error "Compiler that is not supported yet."
#endif
...
#define REDBUD_VERSION \
  REDBUD_STRING(REDBUD_MAJOR.REDBUD_MINOR_REDBUD_PATCH)
